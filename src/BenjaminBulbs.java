...
public class BenjaminBulbs {
    ...
    private static void toggle(int bulbs) {
...
// all perfect sqr  has odd number of factor others have even number factor in this
//qustion every odd time of travel bulb is on and even factor number is off
